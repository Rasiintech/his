...
OpdOrder = Class.extend(
	{
		...
		let tbldata = []
		frappe.call({
        method: "his.api.get_orders.get_opd_orders", //dotted path to server method
        ...
        // console.log(r)
			tbldata.forEach(order => {
				...
				order.vat_total_plus_5 = (order.grand_total * 1.05).toFixed(2);  // Round to 2 decimal places
		...
		//  let fields = frappe.get_meta("Sales Order").fields
		 	columns = [
			// {title:"ID", field:"name"},
			{title:"Patient", field:"patient", headerFilter:"input"},
			...
			{title:"Total", field:"grand_total" ,  headerFilter:"input",},
			// {title:"Total + Vat", field:"vat_total_plus_5" ,  headerFilter:"input",},
