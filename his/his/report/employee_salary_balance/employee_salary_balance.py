...
class AccountReceivableSummary(ReceivablePayableReport):
	...
	def get_data(self, args):
		...
		for party, party_dict in iteritems(self.party_total):
			...
			row.salary = frappe.get_value("Employee",party,"salary")
			row.employment_type = frappe.get_value("Employee",party,"employment_type")
	...
	def get_columns(self):
		...
		self.add_column(_("Empoyee Name"), fieldname="employee_name", width=300, fieldtype="Data")
		# self.add_column(_("Salary"), fieldname="salary", width=200, fieldtype="Data")
		...
		# self.add_column(_(), fieldname="credit_note")
		self.add_column(_("Employment Type"), fieldname="employment_type", fieldtype="Data")
		self.add_column(_("Salary"), fieldname="salary")
